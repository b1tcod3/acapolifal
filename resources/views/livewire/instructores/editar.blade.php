<div>
    <div class="mb-6 flex justify-between items-center">
        <h2 class="text-2xl font-semibold text-gray-800">Editar Instructor</h2>
        <div class="flex space-x-2">
            <a href="{{ route('instructores.ver', $instructor->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-800 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition">
                Volver a Detalles
            </a>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
        ...
        <div class="border-t border-gray-200 px-4 py-5 sm:p-6">
            <form wire:submit.prevent="update">
                ...
                <div class="mt-6">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <select name="especialidad" id="especialidad" wire:model="especialidad" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <select name="nivel_educativo" id="nivel_educativo" wire:model="nivel_educativo" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                            ...
                            @error('nivel_educativo') <span class="text-xs text-red-600">{{ $message }}</span> @enderror
                        </div>
                ...
                <div class="mt-6">
                    <label for="certificados" class="block text-sm font-medium text-gray-700">Certificados</label>
                    <textarea name="certificados" id="certificados" wire:model="certificados" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                    @error('certificados') <span class="text-xs text-red-600">{{ $message }}</span> @enderror
                </div>
