<div x-data="{ show: false, itemId: null }" x-show="show" class="fixed inset-0 overflow-y-auto" style="display: none;">
...
<script>
    function showDeleteConfirmation(id) {
        window.dispatchEvent(new CustomEvent('show-delete-confirmation', { detail: id }));
    }
</script>